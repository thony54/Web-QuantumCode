...
const Home: React.FC = () => {
  return (
    <div className="w-full bg-black text-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex flex-col justify-center px-4 pt-20 border-b border-white/10">
        <div className="absolute inset-0 border-grid opacity-30"></div>
        
        {/* Abstract Background Element */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-tr from-gold/10 via-neon-blue/5 to-transparent rounded-full blur-[100px] pointer-events-none"></div>
        
        <div className="max-w-7xl mx-auto w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-end pb-20">
           
           <div className="lg:col-span-8">
              <div className="inline-flex items-center gap-2 px-3 py-1 border border-neon-blue/30 rounded-full text-neon-blue text-xs font-mono mb-8 bg-neon-blue/5">
              ...
              <p className="font-mono text-sm md:text-base text-gray-400 max-w-2xl leading-relaxed border-l border-gold pl-6 py-2">
           ...
           <div className="lg:col-span-4 flex flex-col justify-end items-start lg:items-end">
              ...
              <div className="flex flex-col gap-4 w-full">
                 <Link to="/servicios" className="group w-full border border-white/20 p-4 hover:bg-white hover:text-black transition-all duration-300 flex justify-between items-center">
                    <span className="font-mono text-sm uppercase tracking-widest">Explorar Servicios</span>
                    <ArrowRight className="group-hover:translate-x-2 transition-transform" size={18} />
                 </Link>
                 <Link to="/contacto" className="group w-full bg-gold text-black p-4 font-bold uppercase tracking-widest hover:bg-white transition-colors flex justify-between items-center clip-corner">
        ...
        {/* Decorative Specs */}
        <div className="absolute bottom-10 left-8 font-mono text-[10px] text-gray-600 hidden md:block">
           COORD: 45.922 / -12.004 <br/>
           SEC: A-99
        </div>
        <div className="absolute top-32 right-8 font-mono text-[10px] text-gray-600 hidden md:block text-right">
           MEMORY: 98% <br/>
           CPU: OPTIMIZED
        </div>
      </section>
